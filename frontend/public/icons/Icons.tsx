...
export function TurneraIcon({ width, height, stroke = "#FDEEA3" }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1555_6938)">
      ...
      <defs>
        <filter id="filter0_d_1555_6938" x="94.0527" y="156.343" width="323.896" height="232.923" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
...
export function TratamientoIcon({ width, height, stroke }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1555_6761)">
...
export function DownloadIcon({ width, height, stroke = "#111" }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill='none' xmlns="http://www.w3.org/2000/svg">
      <path d="M21 15V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V15M7 10L12 15M12 15L17 10M12 15V3" stroke={stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
...
export function InstitucionIcon({ width, height, stroke, classname }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} viewBox="0 0 40 40" className={classname} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1543_10076)">
        <path d="M35.7144 1.42871H4.28585C2.7079 1.42871 1.42871 2.7079 1.42871 4.28585V35.7144C1.42871 37.2924 2.7079 38.5716 4.28585 38.5716H35.7144C37.2924 38.5716 38.5716 37.2924 38.5716 35.7144V4.28585C38.5716 2.7079 37.2924 1.42871 35.7144 1.42871Z" stroke="#F9F9F9" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14.2856 12.8574V27.1431" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M25.7144 12.8574V27.1431" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14.2856 20H25.7142" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs>
...
export function Medicament_admin({ width, height, stroke, classname }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} className={classname} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1543_10071)">
        <path d="M8.94287 22.4857L22.4857 8.94287" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17.5144 31.0571L31.0573 17.5142" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
...
export function IconPatalogia_Admin({ width, height, stroke, classname }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} className={classname} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.28564 1.42871V35.7144" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4.28564 1.42871H20.7142C25.0536 1.42871 28.5714 4.94648 28.5714 9.28585C28.5714 13.6252 25.0536 17.143 20.7142 17.143H4.28564" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12.8572 17.1426L35.7143 38.5712" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M17.1428 38.5714L35.7143 20" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
...
export function IconFarmaceutica_Admin({ width, height, stroke, classname }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} viewBox="0 0 40 40" className={classname} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M4.37822 23.9555L3.74482 18.326C3.55425 16.6322 4.87959 15.1494 6.58405 15.1494H33.4159C35.1202 15.1494 36.4457 16.6322 36.2551 18.326L35.6217 23.9555C35.2042 27.6654 33.0411 30.7941 30.0071 32.5598C30.4917 33.4327 30.8294 34.403 30.9848 35.4401C31.1782 36.7316 30.1779 37.8927 28.8722 37.8927H11.1277C9.82191 37.8927 8.82165 36.7316 9.01508 35.4401C9.17042 34.403 9.50811 33.4327 9.99262 32.5598C6.9588 30.7941 4.79565 27.6654 4.37822 23.9555Z" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M21.3394 15.0891L28.1202 4.46102C29.1293 2.87931 31.2236 2.40492 32.8159 3.39742C34.4416 4.41079 34.919 6.56108 33.875 8.16722L29.3753 15.0891" stroke="white" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M15.0034 26.5215H24.9964" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 21.5244V31.5173" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function AdherenciasIcon_Admin({ width, height, stroke, classname }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} className={classname} viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14.2549 1C13.7815 1 13.3977 1.38376 13.3977 1.85714V4.26791H10.987C10.5136 4.26791 10.1299 4.65165 10.1299 5.12505V7.91077C10.1299 8.38415 10.5136 8.76791 10.987 8.76791H13.3977V11.1786C13.3977 11.652 13.7815 12.0357 14.2549 12.0357H17.0406C17.514 12.0357 17.8977 11.652 17.8977 11.1786V8.76791H20.3085C20.7818 8.76791 21.1656 8.38415 21.1656 7.91077V5.12505C21.1656 4.65165 20.7818 4.26791 20.3085 4.26791H17.8977V1.85714C17.8977 1.38376 17.514 1 17.0406 1H14.2549Z" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1 17.7144L5.18925 21.2055C5.80542 21.7189 6.58209 22.0002 7.38417 22.0002H18.4286C19.2175 22.0002 19.8571 21.3606 19.8571 20.5716C19.8571 18.9936 18.5779 17.7144 17 17.7144H9.32164" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.14286 16.0001L7.42857 17.2857C8.13865 17.9959 9.28991 17.9959 10 17.2857C10.7101 16.5756 10.7101 15.4244 10 14.7144L8.0042 12.7186C7.36122 12.0756 6.48915 11.7144 5.57984 11.7144H1" stroke={stroke} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
...
export function ClipIcon({ width, height, stroke }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} viewBox="0 0 8 8" fill={stroke} xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_1764_5853)">
        <path d="M7.65025 3.19998C7.58774 3.13749 7.50297 3.10239 7.41459 3.10239C7.3262 3.10239 7.24143 3.13749 7.17892 3.19998L3.54825 6.84631C3.39349 7.0011 3.20975 7.12388 3.00754 7.20766C2.80532 7.29144 2.58859 7.33457 2.3697 7.33458C1.92765 7.33461 1.50369 7.15904 1.19109 6.84648C0.878483 6.53392 0.702848 6.10999 0.702817 5.66793C0.702785 5.22588 0.878361 4.80192 1.19092 4.48931L4.70725 0.958647C4.89528 0.773611 5.14881 0.67037 5.41261 0.671413C5.67642 0.672456 5.92912 0.777699 6.11568 0.964216C6.30225 1.15073 6.40755 1.40341 6.40865 1.66722C6.40976 1.93102 6.30658 2.18457 6.12159 2.37265L2.60525 5.90331C2.54184 5.96407 2.45741 5.99798 2.36959 5.99798C2.28176 5.99798 2.19734 5.96407 2.13392 5.90331C2.07143 5.8408 2.03632 5.75604 2.03632 5.66765C2.03632 5.57926 2.07143 5.49449 2.13392 5.43198L5.26459 2.28698C5.3253 2.22411 5.3589 2.13991 5.35814 2.05251C5.35738 1.96511 5.32233 1.88151 5.26052 1.81971C5.19872 1.7579 5.11512 1.72285 5.02772 1.72209C4.94032 1.72133 4.85612 1.75493 4.79325 1.81565L1.66259 4.96065C1.56971 5.05351 1.49603 5.16375 1.44577 5.28509C1.3955 5.40643 1.36963 5.53648 1.36963 5.66781C1.36963 5.79915 1.3955 5.9292 1.44577 6.05054C1.49603 6.17187 1.56971 6.28212 1.66259 6.37498C1.85312 6.55681 2.10638 6.65825 2.36975 6.65825C2.63313 6.65825 2.88638 6.55681 3.07692 6.37498L6.59292 2.84398C6.89892 2.53008 7.06893 2.10826 7.06612 1.6699C7.06331 1.23154 6.88791 0.81194 6.57791 0.501988C6.26792 0.192036 5.84829 0.0166954 5.40993 0.0139488C4.97157 0.0112021 4.54977 0.181271 4.23592 0.487314L0.719585 4.01798C0.281978 4.45559 0.0361328 5.04911 0.0361328 5.66798C0.0361328 6.28685 0.281978 6.88037 0.719585 7.31798C1.15719 7.75559 1.75072 8.00143 2.36959 8.00143C2.98846 8.00143 3.58198 7.75559 4.01959 7.31798L7.65025 3.67265C7.68139 3.64167 7.70611 3.60485 7.72297 3.56429C7.73983 3.52373 7.74852 3.48024 7.74852 3.43631C7.74852 3.39239 7.73983 3.3489 7.72297 3.30834C7.70611 3.26778 7.68139 3.23096 7.65025 3.19998Z" fill="#2E3133" />
      </g>
      <defs>
        <clipPath id="clip0_1764_5853">
...
export function ImageIcon({ width, height, stroke }: IconPropsAdmin) {
  return (
    <svg width={width} height={height} viewBox="0 0 7 7" fill={stroke} xmlns="http://www.w3.org/2000/svg">
      <path d="M5.45065 6.62498L2.64996 4.00171C2.60166 3.96148 2.54079 3.93945 2.47793 3.93945C2.41508 3.93945 2.35421 3.96148 2.30591 4.00171L0.257812 5.47463" stroke="#867CD8" strokeWidth="0.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4.92969 3.93945C4.51547 3.93945 4.17969 3.60367 4.17969 3.18945C4.17969 2.77524 4.51547 2.43945 4.92969 2.43945C5.3439 2.43945 5.6797 2.77524 5.6797 3.18945C5.6797 3.60367 5.3439 3.93945 4.92969 3.93945Z" stroke="#867CD8" strokeWidth="0.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M0.25 6.12498V0.874968C0.25 0.742358 0.302678 0.615183 0.396446 0.521413C0.490215 0.427647 0.61739 0.374968 0.75 0.374968H2.595C2.70922 0.371641 2.82113 0.407535 2.91211 0.476675C3.00308 0.545813 3.06763 0.644028 3.095 0.754968L3.25 1.37497H6.25C6.3826 1.37497 6.5098 1.42765 6.60355 1.52141C6.6973 1.61518 6.75 1.74236 6.75 1.87497V6.12498C6.75 6.25758 6.6973 6.38478 6.60355 6.47853C6.5098 6.57228 6.3826 6.62498 6.25 6.62498H0.75C0.61739 6.62498 0.490215 6.57228 0.396446 6.47853C0.302678 6.38478 0.25 6.25758 0.25 6.12498Z" stroke="#867CD8" strokeWidth="0.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}