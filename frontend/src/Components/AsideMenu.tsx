...
export const AsideMenu: React.FC<MenuProps> = ({
  ...
  return (
    <>
      <aside
        className={`fixed z-50  duration-700 left-0 h-full border-2 bg-white text-white transition-transform transform ${isSidebarOpen ? "translate-x-0 z-10" : "-translate-x-full z-10"
          }`}
      >
