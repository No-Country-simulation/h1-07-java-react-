...
export const HeaderProfile: React.FC<HeaderProfileProps> = ({ loading, children, name, lastname, typeDocument, financier, document, to }) => {
  ...
  return (
    <>
      ...
      <header className='p-6 font-inter z-20 h-48 relative top-[-2vh] flex flex-col items-center justify-center bg-gradient-to-r from-indigo-300 to-indigo-500 rounded-br-[4rem] shadow-2xl'>
        <div className="w-full flex flex-col items-start">
          <div className="mb-6 text-center relative flex flex-col items-center justify-center w-full">
            ...
            <div className="flex items-center justify-center">
              <h1 className="text-xl font-bold text-light-color ml-4">Detalle de Paciente</h1>
