...
export function Onboarding() {
	...
	return (
		<main className="flex flex-col justify-center items-center min-h-screen bg-white overflow-hidden bg-cover bg-center md:bg-white xl:bg-white" style={{ backgroundImage: 'url(Imagen-1.png)' }}>
			<div className="flex flex-col justify-center items-center rounded-t-[10%]  w-full h-[50%] bg-white xl:bg-transparent fixed top-[25rem] md:relative md:top-[2rem] md:rounded-md" >
				<section className="flex flex-col items-center w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] xl:text-white bg-white xl:bg-transparent xl:shadow-xl xl:shadow-black p-5 md:p-10 rounded-md shadow-lg mb-20 ">
					...
					<p className="text-[#948ABC] xl:text-white font-inter text-center mt-3 w-[80%] md:w-full xl:w-[70%] text-[12px] md:text-[16px] lg:text-[20px] xl:text-[20px] 2xl:text-[30px] ">
					...
					<div className='flex flex-col items-center mt-6'>
						...
						<p className="mt-4 text-[18px] text-primary-brand-dark font-bold font-inter xl:text-white">
							ó
						</p>
						<Link to={"/login"}>
							<p className="text-primary-brand-dark font-bold font-inter mb-2 md:text-[14px] lg:text-[25px] xl:text-[16px] xl:text-white ">
								Iniciar sesión
							</p>
						</Link>
					</div>
