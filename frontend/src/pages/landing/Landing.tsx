...
export const Landing = () => {
  const question_One =
    "Para poder registrarse dentro de la aplicacion lo que necesitas en tu numero de matricula como medico, esto habilita la entrada al sistema.";
  const question_Two =
    "Cora esta diseñado para ofrecer información y soporte general, pero no sustituye la opinión de un profesional de la salud.";
  const question_Three =
    "Todos los datos que registre dentro de la aplicacion queda reguardados y solo el medico asigna puede revisar los mismos.";
  const question_four =
    "Si, actualmente solo existe la version mobile, en un futuro queremos poder hacer la version para computadora para una mejora experiencia de usuario";
  const question_five =
      ...
      <article className="flex flex-col md:pl-0  ">
        ...
        >
          <div className="flex  w-full flex-col md:flex-col mt-2 md:mt-30 md:ml-10">
            <h2
              className={`mt-5 text-center md:text-start md:mb-4 md:text-[3rem] md:mt-0 text-white ${styles.h2}`}
            >
              JUSTINA.IO
            </h2>
            <p className="md:text-3xl text-2xl font-[300] mt-5 w-[80%] ml-4 font-inter mb-4 md:mt-4 text-white  md:w-[80%]">
              Creemos en un enfoque integral y humano, donde cada paciente
              recibe el apoyo necesario en cada etapa de su tratamiento.
            </p>
            <Link to="/onboarding">
              <Button className="rounded-md bg-[#E08733] ml-5 mt-6 mb-10 drop-shadow-lg  w-36 md:mt-5 h-12 text-white font-[300] font-inter ">
                Acceder
              </Button>
            </Link>
          </div>
        ...
        <section className="flex flex-col gap-y-8 md:hidden content-center">
          ...
          <div className="flex flex-col ml-5">
            <h2
              className={`${styles.h2} text-[#5956E9] font-inter font-[600] text-[27px] h-[3rem] mt-16 `}
            >
              Una Web App Para Todos
            </h2>
            <p className=" text-black leading-6 tracking-wide text-sm w-[90%] font-inter font-[500]">
              Diseñada para transformar la experiencia en el cuidado de la
              salud. Nuestra misión es proporcionar soluciones eficientes tanto
              a pacientes como a médicos, mejorando la comunicación, agilizando
              procesos y brindando un acompañamiento continuo. Destacamos
              especialmente en el área de trasplantes de órganos, ofreciendo
              herramientas y recursos que facilitan este delicado y vital
              proceso
            </p>
          </div>
        ...
        <section className="hidden md:flex md:flex-row md:mt-32 md:mb-24 ">
          ...
          <div className="md:ml-20 md:w-[40%]">
            <h5 className={`${styles.h5} md:text-black font-inter`}>
              ACERCA DE
            </h5>
            <h2
              className={`${styles.h2} text-[#5956E9] md:text-5xl md:w-[80%] md:font-semibold md:mb-4 `}
            >
              Una web app para todos
            </h2>
        ...
        >
          ...
          <h2
            className={`md:text-5xl md:font-[600] md:w-[60%] font-[500] font-inter ${styles.h2}`}
          >
        ...
        <section className="flex flex-col mt-10">
          <div className="text-center gap-y-4 md:flex md:flex-col md:mb-10">
            <h2
              className={`md:font-bold md:font-inter md:text-5xl text-3xl font-inter text-blue-juli-color ${styles.h2} mb-4`}
            >
              Lo Que Ofrecemos
            </h2>
            <h5
              className={` ${styles.h5} text-black font-[400] mb-10 text-lg font-inter`}
            >
          ...
          <div className="hidden md:flex md:flex-row md:items-center md:justify-between ">
            ...
            <div className="md:flex md:flex-col md:pr-20 md:w-[45%]">
              ...
              <h5 className={`${styles.h5} `}>
                “CORA” Nuestro bot de ayuda está disponible las 24 horas del
                día, los 7 días de la semana, ofreciendo respuestas rápidas y
                precisas a las preguntas de los pacientes, recordatorios de
          ...
          <div className="hidden md:flex md:flex-row md:items-center md:justify-between ">
            <div className="md:flex md:flex-col md:pr-20 md:w-[45%] md:ml-32">
              ...
              <h5 className={`${styles.h5} `}>
                Justina.IO se centra en coordinar a especialistas de la salud
                para gestión y coordinación de trasplantes de órganos, brindando
          ...
          <div className="hidden md:flex md:flex-row md:items-center md:justify-between ">
            ...
            <div className="md:flex md:flex-col md:pr-20 md:w-[45%]">
              ...
              <h5 className={`${styles.h5} `}>
                ...
                accesible a usuarios de todas las edades y niveles de
                experiencia tecnológica. Esto garantiza que tanto pacientes como
                médicos puedan beneficiarse de nuestras soluciones sin
                complicaciones.
              </h5>
            </div>
          </div>
        ...
        >
          ...
          <h5 className={`w-[60%] ml-3 font-inter text-white ${styles.h5}`}>
            Las mas solicitadas de nuestros servicios
          </h5>
          <Accordion className="flex flex-col text-white ">
            <AccordionItem
              className="bg-cyan-500 rounded-md pl-3 border-2 border-solid border-gray-500 text-white"
              title={`¿Como me regitros en Justina.IO? `}
            >
              {question_One}
            </AccordionItem>
            <AccordionItem
              className="bg-cyan-500 rounded-md pl-3 border-2 border-solid border-gray-500"
            ...
            <AccordionItem
              className="bg-cyan-500 rounded-md pl-3 border-2 border-solid border-gray-500"
              title={`¿Como manejar la privacidad de mis datos?`}
            >
              {question_Three}
            </AccordionItem>
            <AccordionItem
            ...
            <AccordionItem
              className="bg-cyan-500 rounded-md pl-3 border-2 border-solid border-gray-500"
              title={`¿Como programar una cita con mi médico a través de JUSTINA.IO?`}
            >
              {question_five}
            </AccordionItem>
          </Accordion>
        ...
        >
          <div className="md:flex md:flex-col md:pl-10">
            <h2
              className={`md:font-inter md:font-[600] md:mb-7 md:text-5xl md:text-white ${styles.h2}`}
            >
              Preguntas Frecuentes
            </h2>
            <h5
              className={`md:font-inter md:text-white ${styles.h5} md:w-[70%] md:text-lg`}
            >
              Pellentesque cras adipiscing tempus libero vel nullam mauris
              tellus. Aliquam ultrices tellus consequat amet, lectus aliquam est
              in neque.
            </h5>
          </div>
          ...
          <div className="md:flex md:flex-row md:mt-10 mb-3">
            ...
            <div className="flex flex-col items-center md:w-[100%] mt-10">
              ...
              <img
                ...
                alt=""
              />
              <p className="font-semibold md:w-[25%] md:text-gray-500 md:mt-2">
                Doctor Ortega (Médico internista)
              </p>
            </div>
          </div>
      ...
      <footer className="flex md:hidden flex-col p-4 bg-[#232233] mt-4">
        ...
        <div className="bg-[#5956e9] px-10 py-10">
          ...
          <form action="" className="flex items-center">
            ...
            <button className="bg-[#e09733] px-3 py-3 mr-22 rounded-se-md rounded-ee-md">
              <FlechaIcon width={24} height={24} />
            </button>
          </form>
          <p className="text-white mt-6 leading-[24px] font-inter text-small font-[400]">
            ¿Quieres estar al día con las últimas novedades y recibir
            recordatorios importantes? Suscríbete a nuestras notificaciones por
            correo electrónico.
          </p>
        </div>
        <div className="mb-7 mt-4 ml-4">
          <h6 className="tracking-wider mb-1 font-bold text-white font-inter">
            Jusinta.IO
          </h6>
        ...
        <ul className="list-none flex justify-center gap-x-6 mb-10">
          {[
            ...
            <GitBrantIcon width={20} height={20} />,
          ].map((icon, idx) => (
            <li
              key={idx}
              className="border-2 rounded-full w-12 h-12 items-center justify-center flex cursor-pointer hover:scale-105 transition-all duration-300"
            >
              {icon}
            </li>
          ))}
          ...
          <div className="md:mt-20 md:rounded-md md:w-[110%] md:bg-[#5956E9] md:p-10">
            ...
            <form className="flex items-center">
              <input
                ...
                className="bg-light-color px-6 rounded-lg border-none p-2 text-black"
              />
              <button className="bg-[#E08733] py-[11px] px-3 rounded-se-medium rounded-ee-medium relative right-10">
                {" "}
                <FlechaIcon width={20} height={20} />{" "}
              </button>
            </form>
            <p className="md:w-[120%] md:font-inter md:text-sm md:mt-3 md:font-[300] ">
              ¿Quieres estar al día con las últimas novedades y recibir
              recordatorios importantes? Suscríbete a nuestras notificaciones
              por correo electrónico.{" "}
            </p>
          </div>
        </div>

        <span className="md:border-t-2 md:border-gray-color w-[80%] mt-20"></span>
