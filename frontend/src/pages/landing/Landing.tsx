...
import { ArrowIcon, ArtistIcon, AvatarIcon, CloudIcon, FacebookIcon, FeaturesIcon, HamburguerIcon, LinkedinIcon, SecurityIcon, StarIcon, StorageIcon, TimeIcon, UpdateIcon, VideoIcon } from '../../components/icons/Icons'
...
export const Landing = () => {
  ...
  return (
    <main className=' border-2 border-gray w-96 m-auto max-md:w-full'>
      <nav className=' flex justify-between p-4 border-b-2 border-gray-300 items-center'>
        <img src={'./public/logo-justina.webp'} className=' w-40' alt="logo-justina" />
        <span className=' cursor-pointer transition-all duration-300 hover:scale-105'>
          <HamburguerIcon width={30} height={30}></HamburguerIcon>
        </span>
      </nav>
      <article className=' p-4 flex flex-col gap-y-10'>
        <section className=' flex flex-col gap-y-4'>
          <h2 className=' font-bold text-2xl'>JUSTINA.IO</h2>
        ...
        <section className=' flex flex-col gap-y-8'>
          <h5 className=' uppercase text-gray-color text-xl'>Acerca de</h5>
          <h2 className='text-2xl font-semibold'>Etiam nulla lectus amet nunc molestie </h2>
        ...
        <section className='flex flex-col gap-y-8 items-center text-center'>
          <h5 className='uppercase text-gray-color text-xl'>Servicios</h5>
          <h2 className='text-2xl font-semibold'>Etiam nulla lectus amet nunc molestie at vulputate.</h2>
          <h5 className=' text-gray-color text-xl'>Neque, pulvinar vestibulum non aliquam.</h5>
          <li className=' list-none flex flex-col gap-y-16'>
            {items.map((item, index) => (
              <ol key={index} className=' flex flex-col justify-center items-center'>
        ...
        <section className=' flex flex-col gap-y-8'>
          <div className=' text-center gap-y-4 flex flex-col'>
            <h2 className='text-3xl font-semibold'>Diferenciadores</h2>
            <h5 className='text-gray-color text-xl'>Neque, pulvinar vestibulum non aliquam.</h5>
          </div>
          <div className="flex flex-col gap-4">
            <h4 className='text-2xl font-semibold'>Purus id tellus arcu habitant proin magna. Integer purus </h4>
            <h5 className='text-gray-color text-xl'>Facilisi viverra dictum augue eu lobortis elit. In et donec habitasse lacus mi commodo elementum.</h5>
            <img src={'./public/Image-generic.png'} alt="image-landing-page" />
          </div>
          <div className="flex flex-col gap-4">
            <h4 className='text-2xl font-semibold'>Purus id tellus arcu habitant proin magna. Integer purus </h4>
        ...
        <section className='flex flex-col gap-y-6'>
          ...
          <h5 className='text-gray-color text-xl'>Pellentesque cras adipiscing tempus libero vel nullam mauris tellus. Aliquam ultrices tellus consequat amet, lectus aliquam est in neque.</h5>
      ...
      <footer className='flex flex-col  gap-y-8 p-4'>
        <div>
          ...
          <li className=' flex flex-col list-none text-gray-color'>
            <ol>Mi feugiat</ol>
