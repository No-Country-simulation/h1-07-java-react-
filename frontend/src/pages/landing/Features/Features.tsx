    ...
    <section id="features" className="flex flex-col mt-10">
      <div className="text-center gap-y-4 md:flex md:flex-col md:mb-10">
        ...
        <motion.h5
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className={`font-semibold text-black mb-10 font-inter`}
        >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="hidden md:flex md:flex-row md:items-center md:justify-between"
      >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="flex flex-col items-center mt-10 md:hidden"
      >
        <div className="md:flex md:flex-col md:pl-20">
