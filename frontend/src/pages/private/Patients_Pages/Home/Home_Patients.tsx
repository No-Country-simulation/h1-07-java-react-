...
export function Home_Patients() {
  ...
  const menuItems = [
    ...
    {
      to: "/userInfo_Patien",
      icon: ConfigurationIconSideMenu,
      label: "Configuración",
    },
      ...
      <div className="w-full max-w-md min-h-screen font-inter bg-white rounded-lg shadow-lg  max-md:m-auto">
        ...
        >
          <div className="py-10 flex flex-col">
            <h1 className="w-[33vh] text-xl font-bold mb-5 text-center text-black">
              MENÚ
            </h1>
            <ul className="w-[30vh] ml-3">
              {menuItems.map((item, index) => (
                <Link to={item.to} key={index}>
                  <li
                    className={`border-1 border-solid border-gray-500 mb-5 flex items-center p-3 rounded-lg ${
                      location.pathname === item.to
                        ? "bg-[#ffffff] hover:bg-[#9b9595]"
                        : "text-black hover:bg-[#9b9595]"
                    }`}
                  >
          ...
          <div className="flex flex-row mt-4 justify-between w-full ">
            <Link to="/user-info-patient">
              <div className="flex items-center space-x-2">
                <img
                  src="./public/IMG_MEDICO/IMG_Pacientes_3.png"
                  className="w-12"
                  alt=""
                />
                <div>
        ...
        <section className="px-4 py-2 grid grid-cols-3 gap-4">
          {patientOptions.map((option, index) => (
            ...
            >
              <div
                className={` w-[7rem] h-[7rem] rounded-3xl flex items-center justify-center`}
              >
            ...
            <div className="flex flex-col mt-10 p-3 w-full border-1 border-solid border-gray-400 rounded-xl mb-10">
              <Link to={"/Medic_Appointment"} className="">
                <div className="flex flex-row ">
                  ...
                  <img
                    src="./public/IMG_PATIENTS/IMG_PATIENS_MEDICO_1.png"
        ...
        <section className="flex ml-5 mb-10 flex-col">
          ...
          <div className="flex flex-row gap-x-8 justify-center">
            <div className="flex flex-col">
              <img
                src="./public/IMG_PATIENTS/IMG_PATIENS_MEDICO_2.png"
            ...
            <div className="flex flex-col">
              <img
                src="./public/IMG_PATIENTS/IMG_PATIENS_MEDICO_3.png"
                className="rounded-full"
                alt=""
              />
            ...
            <div className="flex flex-col">
              <img
                src="./public/IMG_PATIENTS/IMG_PATIENS_MEDICO_4.png"
                className="rounded-full"
                alt=""
              />
              <p className="font-inter font-bold text-[13px] mt-3">
            ...
            <div className="flex flex-col ">
              <img
                src="./public/IMG_PATIENTS/IMG_PATIENS_MEDICO_5.png"
