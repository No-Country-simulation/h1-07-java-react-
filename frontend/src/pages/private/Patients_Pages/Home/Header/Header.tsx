...
export default function Header({ toggleSidebar, nombre, apellido, notifications }: { toggleSidebar: () => void, nombre: string | undefined, apellido: string | undefined, notifications: NotificationProps[] | undefined }) {
  return (
