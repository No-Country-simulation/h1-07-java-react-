...
export default function Nutrition() {
  ...
  return (
    <main className="w-full min-h-screen bg-gradient-to-t from-[#FF8D35] to-[#5561D9] py-8">
        ...
        <div className="px-32 max-lg:px-16 max-md:px-8 pb-4">
          ...
          <section className=" flex flex-col gap-4">
            <div className="flex flex-col justify-center items-center">
              <img src="nutrition.png" width={300} alt="image-mental" />
              <p className="mt-4 text-xl font-semibold text-center px-60 max-lg:px-40 max-md:px-12 text-light-color">Alimentos o dietas asignados por su especialista para complementar su tratamiento</p>
            </div>
            <ol className=" items-center flex justify-center m-auto max-md:w-full flex-col gap-2">
              {treatments && treatments.content.some(treatment => treatment.tipoTratamientoId === 2) ? (
                treatments.content.map((treatment) => (
                  treatment.tipoTratamientoId !== 2 ? null : (
                    <>
                ...
                <p className="text-center text-lg text-light-color">
                  No tienes tratamientos de nutrición asignados.
                </p>
              )}
            </ol>
          </section>
