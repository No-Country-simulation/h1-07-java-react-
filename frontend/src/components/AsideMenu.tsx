    ...
    <>
      ...
      >
        <div className="py-10 flex flex-col xl:items-center ">
          <img src={src} alt="" className=" hidden xl:block" />
          <h3 className="text-xl font-bold  my-4 text-center text-black ">
            MENÚ
          </h3>
          <span
                ...
                <>
                  <Link to={"/patient-home"}>
                    ...
                    >
                      <span className=" w-[30px] h-[30px] flex justify-center items-center">
                        <HomeIconTwo width={20} height={20} stroke="#100056" classname={""} />
                      </span>
                  ...
                  {menuPatient.map((item, index) => (
                    <Link to={item.to} key={index} className="">
                      ...
                      >
                        <item.icon width={30} height={30} stroke="#" classname="" />
                ...
                <div className="xl:flex xl:items-center xl:flex-col">
                  {menuItems.map((item, index) => (
                    <Link to={item.to} key={index} className="w-full">
                      ...
                      >
                        <item.icon width={26} height={26} stroke="#000000" classname="" />
