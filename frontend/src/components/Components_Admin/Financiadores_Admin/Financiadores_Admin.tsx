        ...
        <main>
            ...
            <form action="" className="mt-10 ml-2">
                ...
                <div className="mt-1">
                    ...
                    <input type="text" placeholder="Ej: Swift medical" className="outline-none pl-2 font-inter shadow-custom-right py-3 w-full rounded-lg mt-2   border-orange-500 border-1" />
                </div>
                <div className="mt-5">
                    <h2 className="font-inter text-black">Dirreción</h2>
                    <input type="text" placeholder="Ej: Buenos Aires, Argentina" className="outline-none pl-2 font-inter shadow-custom-right py-3 w-full rounded-lg mt-2   border-orange-500 border-1" />
                </div>
                <div className="mt-5">
                    <h2 className="font-inter ">Correo</h2>
                    <input type="email" placeholder="Ej: tuemail@gmail.com" className="outline-none pl-2 font-inter shadow-custom-right py-3 w-full rounded-lg mt-2   border-orange-500 border-1" />
                </div>
            ...
            <section className="mb-2 w-full shadow-custom-right rounded-xl border-1 border-solid border-orange-600 py-2 px-1">
                ...
                <div className="flex flex-row items-center pl-2 pt-1 border-b-3 border-orange-400 rounded-xl pb-4 mt-2">
                    ...
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Galeno</h2>
                ...
                <div className="flex flex-row items-center pl-2 pt-2 border-b-3 border-orange-400 rounded-xl pb-4 mt-2">
                    <IconFinaciadores_Admin width={66} height={66} classname="rounded-lg bg-orange-600 p-2" stroke="#fff" />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Sancor</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-center pl-2 pt-2 border-b-3 pb-3 border-orange-400 rounded-xl  mt-2">
                    <IconFinaciadores_Admin width={66} height={66} classname="rounded-lg bg-orange-600 p-2" stroke="#fff" />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Swift medical</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-center pl-2 pt-2 border-orange-400 rounded-xl  mt-2">
                    <IconFinaciadores_Admin width={66} height={66} classname="rounded-lg bg-orange-600 p-2" stroke="#fff" />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">OSDE</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
