...
export function Medicament_Admin(): JSX.Element {
    return (
        <main className="">
            ...
            <form action="" className="mt-10 ml-2">
                <h2 className="font-inter font-bold text-xl mb-2">Añadir nueva</h2>
                <div className="">
                    <h2 className="font-inter ">Nombre del medicamento</h2>
                    <input type="text" placeholder="Ej: Ibuprofeno" className="outline-none pl-2 font-inter shadow-custom-right py-3 w-full rounded-lg mt-2   border-orange-500 border-1" />
                </div>
                <div className="mt-5">
                    <h2 className="font-inter text-black">Descripción</h2>
                    <input type="text" placeholder="Ej: Comprimidos de 200mg" className="outline-none pl-2 font-inter shadow-custom-right py-3 w-full rounded-lg mt-2   border-orange-500 border-1" />
                </div>
            ...
            <section className="ml-2 mb-2 w-full shadow-custom-right rounded-xl border-1 border-solid border-orange-600 py-2 px-1">
                ...
                <div className="flex flex-row items-center pl-2 pt-1 border-b-3 border-orange-400 rounded-xl pb-4 mt-2">
                    <Medicament_admin width={60} height={60} stroke="#fff" classname="bg-orange-600 p-2 border-1 border-white border-solid " />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Alprazolam</h2>
                ...
                <div className="flex flex-row items-center pl-2 pt-2 border-b-3 border-orange-400 rounded-xl pb-4 mt-2">
                    <Medicament_admin width={60} height={60} stroke="#fff" classname="bg-orange-600 p-2 border-1 border-white border-solid " />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Beciometasona</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
                ...
                <div className="flex flex-row items-center pl-2 pt-2 border-b-3 pb-3 border-orange-400 rounded-xl  mt-2">
                    <Medicament_admin width={60} height={60} stroke="#fff" classname="bg-orange-600 p-2 border-1 border-white border-solid " />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Captopril</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
                <div className="flex flex-row items-center pl-2 pt-2 border-orange-400 rounded-xl  mt-2">
                    <Medicament_admin width={60} height={60} stroke="#fff" classname="bg-orange-600 p-2 border-1 border-white border-solid " />
                    <div className="ml-2">
                        <h2 className="font-inter text-lg font-bold">Ibuprofeno</h2>
                        <p className="font-inter">Ver Detalles</p>
                    </div>
                </div>
            </section>
